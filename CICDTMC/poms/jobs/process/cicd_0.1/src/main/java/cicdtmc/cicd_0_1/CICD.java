 ...
 * @status
 */
public class CICD implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CICD.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(CICD.class);
	...
	private final String jobName = "CICD";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CICD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = CICD.class.getClassLoader()
					.getResourceAsStream("cicdtmc/cicd_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = CICD.class.getClassLoader()
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_CICDTMC_CICD = new byte[0];
		static byte[] commonByteArray_CICDTMC_CICD = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CICDTMC_CICD.length) {
					if (length < 1024 && commonByteArray_CICDTMC_CICD.length == 0) {
						commonByteArray_CICDTMC_CICD = new byte[1024];
					} else {
						commonByteArray_CICDTMC_CICD = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CICDTMC_CICD, 0, length);
				strReturn = new String(commonByteArray_CICDTMC_CICD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CICDTMC_CICD) {
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = "
									+ "\"C:/Users/ADBI202006/Downloads/Folder-Rachida/Talend-workspaces/TMC-workspaces/Remote-workspaces/compare.csv\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
	...
	public static void main(String[] args) {
		final CICD CICDClass = new CICD();

		int exitCode = CICDClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'CICD' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CICD.class.getClassLoader()
					.getResourceAsStream("cicdtmc/cicd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CICD.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CICD");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 56553 characters generated by Talend Cloud Real-Time Big Data Platform on the
 * June 16, 2022 3:32:22 PM CEST
 ************************************************************************************************/